...
<div id="main">
	...
	<div id="page">
		...
		<?php if($current_subject) { ?>
			...
			<br /><a href="edit_subject.php?subject=<?php echo urldecode($current_subject["id"]); ?>">Edit Subject</a>
		...
		<?php } elseif($current_page) { ?>
			<h2>Manage Content&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="edit_page.php?page=<?php echo urlencode($current_page["id"]); ?>" >Edit Page</a></h2>
			...
			<div id="page-content">				
				<div id="cover">
					<br /><img src="images/<?php echo $current_page["menu_name"] ?>.jpg" />
				</div>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Content:
				<div id="view-content">					
